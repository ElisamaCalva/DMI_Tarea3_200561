// Creado por: Elisama Arturo Calva Moreno 200561
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: ' Tarea3_200561', // Título de la aplicación.
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('TAREA 3: 200561',
            style: TextStyle(color: const Color.fromARGB(255, 255, 255, 255))),
        backgroundColor: Color.fromARGB(255, 48, 195, 253),
      ),
      body: Container(
        color:
              ...
              children: <Widget>[
                Center(
                  child: Container(
                    ...
                    child: Text(
                      'TAREA 3 200561 :Estlizacion y uso de Fuentes',
                      style: TextStyle(
                        fontFamily:
                ...
                Image.asset(
                  'assets/uo.jpg', //  ruta de la imagen.
